...
client = chromadb.PersistentClient(path="input_claims.emb.db")  # client.reset() is commented out, could be used to reset the client
...
for file in os.listdir(csv_dir):
    if file.endswith('.csv'):
        ...
        ds = pd.read_csv('summaries.emb/' + file)  # Reading associated summaries
